...
Geist geleitet und regiert werden, so mögen sie
...
aufzuheften, welche, unserm klaren Beweis nach, nicht
...
sei, so sebe ich keine Notwendigkeit, solches zu<!-- Seite 141 -->
...
fonjt nirgends mehr Erwähnung getan) so denken vielleicht
...
Grundsätzen nach, unmöglich, einen bessern Beweis
...
Artikels keine Gewissheit geben kan, das ist nicht
die erste, richtigste und einzige Glaubens-Regel.

Nun kann mir aber die Schrift etc. Deshalb
etc.
...
aber außen zu lassen sind, keine Gewissheit geben kan,
das kann mir deswegen auch keine Gewissheit geben.
